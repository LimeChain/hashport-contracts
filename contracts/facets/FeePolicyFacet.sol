...
contract FeePolicyFacet is IFeePolicyFacet {
    ...
    function setUsersFeePolicy(address _feePolicyAddress, address[] memory _userAddresses) external override {
    ...
    function getUsersFeePolicyAddress(address _userAddress) external view override returns (address) {
        LibDiamond.enforceIsContractOwner();
