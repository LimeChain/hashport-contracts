...
async function mintERC721(routerAddress, sourceChain, targetChain, transactionId, wrappedAsset, tokenId, metadata, receiver, signatures) {
  ...
  const encodeData = ethers.utils.defaultAbiCoder.encode(
    ...
    [sourceChain, targetChain, evmTransactionId, wrappedAsset, tokenId, metadata, receiver]);
